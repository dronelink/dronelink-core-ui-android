...
//    private List<Annotation> funcMapOverlayAnnotations = new ArrayList<>();
    ...
    public MapboxMapController(final MapView mapView) { //TODO constructor parameters final MapboxMap map, final MapView mapView
//        this.map = map;
...
//    }
    ...
    private void setVisibleCoordinates(final List<String> visibleCoordinates, final Double direction) { //TODO parameters were final List<LatLng> visibleCoordinates, final Double direction
...
//            }
    ...
    private List<String> missionReengagementEstimate() { //TODO return type was List<LatLng>
